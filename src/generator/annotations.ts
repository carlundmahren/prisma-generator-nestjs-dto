...
export const DTO_API_CREATE_HIDDEN = /@DtoApiCreateHidden/;
export const DTO_API_UPDATE_HIDDEN = /@DtoApiUpdateHidden/;
export const DTO_API_PLAIN_HIDDEN = /@DtoApiPlainHidden/;
